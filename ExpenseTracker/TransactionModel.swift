...
extension Category {
    ...
    static let entertainment = Category(id: 3, name: "Entartainment", icon: .film)
    ...
    static let publicTransportation = Category(id: 102, name: "Public Transportation", icon: .bus, mainCategoryId: 1)
    ...
    static let bankFee = Category(id: 401, name: "Bank Feed", icon: .hand_holding_usd, mainCategoryId: 4)
